 ...
 *//*
    ...
    private void loadGroup(){
       // String criteria=" WHERE "+SQLiteHandler.COUNTRY_CODE_COL+" = '"+idCountry+"'";
        String criteria="";
 ...
 *//*
    ...
    private void loadSubGroup(final String idGroup){
       // final String idG=idGroup;
        //+SQLiteHandler.COUNTRY_CODE_COL+" = '"+idCountry+"' AND "
 ...
 *//*
    ...
    private void loadLocation(final String groupCode , final String subGroupCode){
      //  Log.d(TAG,"in load location");
        String criteria =  " WHERE "+SQLiteHandler.COUNTRY_CODE_COL +" = '"+idCountry+"' AND "+ sqlH.GROUP_CODE_COL + "='" + groupCode + "' AND " + sqlH.SUB_GROUP_CODE_COL + "='" + subGroupCode + "'";
