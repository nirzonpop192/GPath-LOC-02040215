...
public class AssignForLiberiaCFW extends BaseActivity implements View.OnClickListener {
    ...
    RadioButton c11, c21, c31, c32, c33, c34, c35, c36, c37, c38;
//    String rb11, rb21, rb31, rb32, rb33, rb34, rb35, rb36, rb37, rb38;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assign_for_liberia_cfw);
    ...
    private void fieldIntialization() {
        mContext = AssignForLiberiaCFW.this;
    ...
    private void saveData() {
       ...
       /* checkCiteriaDetails();
        ...
        if (sqlH.ifExistsInRegNAssProgSrv(assignMemData)) {
            ...
            assign.setC11_CT_PR(ctDataModel.getC11CtPr());
            assign.setC21_CT_PR(ctDataModel.getC21CtPr());
            assign.setC31_CT_PR(ctDataModel.getC31CtPr());
            assign.setC32_CT_PR(ctDataModel.getC32CtPr());
            assign.setC33_CT_PR(ctDataModel.getC33CtPr());
            assign.setC34_CT_PR(ctDataModel.getC34CtPr());
            assign.setC35_CT_PR(ctDataModel.getC35CtPr());
            assign.setC36_CT_PR(ctDataModel.getC36CtPr());
            assign.setC37_CT_PR(ctDataModel.getC37CtPr());
            assign.setC38_CT_PR(ctDataModel.getC38CtPr());
    ...
    private void viewsReference() {
        tViewHouseHoldName = (TextView) findViewById(R.id.txt_assign_lib_HHName_cfw);
        tViewHouseHoldId = (TextView) findViewById(R.id.txt_assign_lib_HHID_cfw);
        tViewMemberName = (TextView) findViewById(R.id.txt_assign_lib_MemberName_cfw);
        tViewMemberId = (TextView) findViewById(R.id.txt_assign_lib_MemberID_cfw);
        tViewCriteria = (TextView) findViewById(R.id.txt_assign_lib_Criteria_cfw);
        tViewDate = (TextView) findViewById(R.id.txt_assign_lib_RegDate_cfw);
        btnSave = (Button) findViewById(R.id.btn_assign_liberia_save_cfw);
        btnAssign = (Button) findViewById(R.id.btn_liberia_goAssignePage_cfw);
        choiceGroup = (RadioGroup) findViewById(R.id.choice_cfw);
        ...
        c21 = (RadioButton) findViewById(R.id.ChFhEhDh_cfw);
        c31 = (RadioButton) findViewById(R.id.a_cfw);
        c32 = (RadioButton) findViewById(R.id.b_cfw);
        c33 = (RadioButton) findViewById(R.id.c_cfw);
        c34 = (RadioButton) findViewById(R.id.d_cfw);
        c35 = (RadioButton) findViewById(R.id.e_cfw);
        c36 = (RadioButton) findViewById(R.id.f_cfw);
        c37 = (RadioButton) findViewById(R.id.g_cfw);
        c38 = (RadioButton) findViewById(R.id.h_cfw);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.txt_assign_lib_RegDate_cfw:
                setRegDate();
                break;
            case R.id.btn_assign_liberia_save_cfw:
                saveData();
                break;
            case R.id.btn_liberia_goAssignePage_cfw:
    ...
    public void radioButtonVisibilityController() {
    ...
    {
        final CharSequence [] items = getResources().getStringArray(R.array.cfw_assign_goto_array);

        AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(AssignForLiberiaCFW.this, android.R.style.Theme_Holo_Light_Dialog));
        ...
        builder.setSingleChoiceItems(items, -1, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                switch (item)
                {
                    case 0:
                        finish();
                        intent = new Intent(AssignForLiberiaCFW.this,MainActivity.class);
                        startActivity(intent);
                        break;
                    case 1:
                        finish();
                        intent = new Intent(AssignForLiberiaCFW.this,DistributionActivity.class);
                        intent.putExtra(KEY.DIR_CLASS_NAME_KEY,"AssignForLiberiaCFW");
                        intent.putExtra(KEY.COUNTRY_ID,sqlH.selectCountryCode());
                        startActivity(intent);
                        break;
                    case 2:
                        finish();
                        intent = new Intent(AssignForLiberiaCFW.this,ServiceActivity.class);
                        intent.putExtra(KEY.DIR_CLASS_NAME_KEY,"AssignForLiberiaCFW");
                        intent.putExtra(KEY.COUNTRY_ID,sqlH.selectCountryCode());
                        startActivity(intent);
                        break;
                    ...
                    case 4:
                        finish();
                        intent = new Intent(AssignForLiberiaCFW.this, RegisterLiberia.class);
